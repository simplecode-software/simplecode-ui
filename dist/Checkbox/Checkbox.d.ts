...
import { TButtonOnPress } from '../types';
export declare const Checkbox: React.MemoExoticComponent<React.ForwardRefExoticComponent<Readonly<import("../types").PartialNullable<{
