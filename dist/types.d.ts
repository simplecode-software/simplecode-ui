...
export type TUnknownObject = Readonly<{
    [key: string]: unknown;
}>;
...
export type TColorSetMain = 'primary' | 'secondary' | 'tertiary' | 'accent' | 'success' | 'warning' | 'error' | 'light' | 'grey' | 'dark';
...
export type TThemeField = 'shapes' | 'borders' | 'fonts' | 'shadows' | 'shadowsText' | 'colors' | 'sizes';
export type TColorSlotMain = 'primary' | 'primaryalt' | 'secondary' | 'tertiary' | 'accent' | 'success' | 'warning' | 'error';
...
export type TButtonGroupOnPress = (event: React.BaseSyntheticEvent, buttons?: TActiveButtons | null, name?: string | null) => (void | false);
...
type TGenButtonEmbedNamedList<TGButtonEmbed> = ReadonlyArray<TGenButtonEmbedNamed<TGButtonEmbed> | null>;
...
export type TSizeGetter = (name: TSpecSize | null, prefix: TThemeSizeName) => (number | null);
...
export type TColorSetGetter = (state: 'active' | 'hover' | null, colors: TColorsProp | null) => (string | null);
...
export type TFocusControl = Readonly<{
    focus: TCbVoid;
}>;
