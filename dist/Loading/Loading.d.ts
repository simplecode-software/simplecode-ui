...
import { TSpecSize } from '../types';
export declare const Loading: React.MemoExoticComponent<React.ForwardRefExoticComponent<Readonly<import("../types").PartialNullable<{
