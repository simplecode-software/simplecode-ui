...
export declare const Txt: React.MemoExoticComponent<React.ForwardRefExoticComponent<Readonly<import("../types").PartialNullable<{
    ...
    font: string;
    align: "left" | "right" | "auto" | "center" | "justify";
